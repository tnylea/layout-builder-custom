...
<button
    ...
    class="absolute -top-2 left-1/2 -translate-x-1/2 z-20 w-6 h-6 bg-white border-2 border-green-500 text-green-500 rounded-full flex items-center justify-center shadow-lg cursor-pointer opacity-0 scale-75 group-hover/nested:opacity-100 group-hover/nested:scale-100 transition-all duration-150 hover:bg-green-500 hover:text-white"
